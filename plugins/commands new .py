    ...
    try:
        ...
        if any(tag in bio.lower() for tag in required_tags):
            ...
            approve_text = (
                ...
                f"<b><blockquote> Cheers, <a href='https://t.me/Real_Pirates'>{m.from_user.first_name}</a>! 🥂</blockquote></b>\n"
                f"Your Request To Join <b>{m.chat.title}</b> Has Been Approved! 🎉\n"
               
                f"We’re happy to have you with us. 🥰\n\n"
                f"💎 Member Count: <b>{member_count:,}</b> 🚀\n"
                ╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌╾‌‌‌‌‌‌‌‌‌‌‌
                f"⚠️⚠️⚠️\n"
            ...
            try:
                await client.send_message(-1002479860602, approve_text)
...
To join,{m.chat.title} follow these **2 Simple Steps**: 🤫
...
🔹 **Step 2️⃣**
Try joining again using the invite link 🥰
Once you update your bio with the required tag, **I'll approve your request!** 😉
||/help|| 🌝
"""
